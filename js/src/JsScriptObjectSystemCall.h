#ifndef PALSCRIPTOBJECTSYSTEMCALL_H
#define PALSCRIPTOBJECTSYSTEMCALL_H
...
namespace Js
{
  /** \class ScriptObjectSystemCall ScriptObjectSystemCall.h "ScriptObjectSystemCall.h"
   * \ingroup <<TODO>>Add software unit name here (e.g. PRPLMULTI)
   * <<TODO>>Briefly describe your class here.
   */
   class ScriptObjectSystemCall : public ScriptObjectExternal
   {
   public:
      ...
      // <<TODO>> Declare the methods of your public C++ interface here.
      //          Sort the method names alphabetically.

   private:

      // <<TODO>> Declare your private methods here.
      //          Sort the method names alphabetically.
   ...
   typedef SmartPointer<ScriptObjectSystemCall> ScriptObjectSystemCallPtr;

   // ------------------------------------------------------------------------

   // <<TODO>> Implement the short methods (< 10 lines of code) of your 
